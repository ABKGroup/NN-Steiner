 ...
 *   GST_CALLBACK_BB_ROOT_NODE_DONE:
 * 	Invoked when the root node has finished.  For fractional
 * 	solutions, this is invoked before selecting the branch
 * 	candidate.
 * 
 */
